# The name of this view in Looker is "Lrnasv41684180540742 Orders Order Wrap Hour"
view: lrnasv41684180540742_orders_order_wrap_hour {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: "OLIGARCHY_BRANDIED_SCRATCH__1684179778"."LR$NASV41684180540742_ORDERS_ORDER_WRAP_HOUR" ;;
  ...
  dimension_group: orders_created_at_hour {
    type: time
    timeframes: [raw, time, date, week, month, quarter, year]
    sql: ${TABLE}."orders.created_at_hour" ;;
  }
