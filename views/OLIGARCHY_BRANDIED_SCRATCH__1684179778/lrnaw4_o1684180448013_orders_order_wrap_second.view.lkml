# The name of this view in Looker is "Lrnaw4 O1684180448013 Orders Order Wrap Second"
view: lrnaw4_o1684180448013_orders_order_wrap_second {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: "OLIGARCHY_BRANDIED_SCRATCH__1684179778"."LR$NAW4O1684180448013_ORDERS_ORDER_WRAP_SECOND" ;;
  ...
  dimension_group: orders_created_at_second {
    type: time
    timeframes: [raw, time, date, week, month, quarter, year]
    sql: ${TABLE}."orders.created_at_second" ;;
  }
