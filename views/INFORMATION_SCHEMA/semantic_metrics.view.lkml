# The name of this view in Looker is "Semantic Metrics"
view: semantic_metrics {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: "INFORMATION_SCHEMA"."SEMANTIC_METRICS" ;;
  ...
  measure: count {
    type: count
    drill_fields: [semantic_view_name, name, table_name]
  }
}
